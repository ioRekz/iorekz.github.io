...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13400 = 0;while(true){
var m_13401 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13401 == null))
{} else
{m_13401.call(null);
if((count_13400 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13402 = (count_13400 + 1);
count_13400 = G__13402;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__4187__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__4187__auto__)
