...
{{
var G__10984 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10984;
continue;
}
} else
...
{var pred__10988 = cljs.core._EQ_;var expr__10989 = limit;if(cljs.core.truth_(pred__10988.call(null,1,expr__10989)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__10988.call(null,2,expr__10989)))
...
var G__10991 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10992 = (limit__$1 - 1);
var G__10993 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10991;
limit__$1 = G__10992;
parts = G__10993;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___10995 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___10995))
{var replacement_10996 = temp__4090__auto___10995;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_10996)));
} else
{buffer.append(ch);
}
{
var G__10997 = (index + 1);
index = G__10997;
continue;
}
}
